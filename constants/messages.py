...
MSG_LANGUAGE_NOT_FOUND = (
    "Ошибка: Язык '{language_slug}' не найден. Пожалуйста, выберите из списка."
)
MSG_SELECTED_LANGUAGE_NOT_FOUND_RETRY = (
    "Ошибка: Выбранный язык не найден. Пожалуйста, попробуйте снова."
)
...
# diagnostics_command
MSG_NO_DIAGNOSTIC_QUESTIONS_FOR_LANG = (
    "К сожалению, для выбранного языка пока нет диагностических вопросов."
)

# handle_diagnostic_score
MSG_ERROR_PROCESSING_SCORE = "Произошла ошибка. Попробуйте еще раз."
MSG_ACTIVE_LANGUAGE_NOT_FOUND_ERROR = (
    "Ошибка: не найден активный язык. Пожалуйста, выберите язык через /language."
)
MSG_QUESTION_NOT_FOUND_OR_OLD = "Ошибка: вопрос не найден или устарел."
MSG_SCORE_SAVED_CONTINUE = (
    "Ваша оценка {score} по вопросу '{question_text_short}' сохранена."
)
MSG_ALL_DIAGNOSTIC_QUESTIONS_ANSWERED = (
    "Все диагностические вопросы для языка {language_name} пройдены!"
)
...
MSG_PRACTICE_QUESTION_INTRO = (
    "Практический вопрос по теме: **{category_name}**\nЯзык: {language_name}"
)
...
MSG_NEW_PRACTICE_QUESTIONS_READY = (
    "Я подготовил для вас {count} новых вопросов. Начнем!"
)
...
MSG_UNEXPECTED_ERROR_PRACTICE_PLAN = (
...
MSG_CANT_MATCH_ANSWER_TO_QUESTION = (
    "Произошла ошибка: не могу соотнести ваш ответ с вопросом. Попробуйте /practice."
)
MSG_THANKS_FOR_ANSWER_ANALYZING = "Спасибо за ответ! Сейчас я его проанализирую... 🤔"
MSG_ACTIVE_LANG_NOT_DEFINED_START_OVER = (
    "Ошибка: не определен активный язык. Пожалуйста, начните с /start."
)

# Simplified Flow Messages
MSG_PRACTICE_PLAN_READY_USE_PRACTICE = (
    "Ваш персональный план подготовки готов! Чтобы начать, отправьте команду /practice."
)
...
MSG_DIAGNOSTICS_AUTO_START_FAIL = (
    "Не удалось автоматически начать диагностику. Попробуйте команду /diagnostics."
)
...
MSG_LLM_NOT_AVAILABLE_ERROR = (
    "Ошибка: Модель ИИ недоступна. Не могу сгенерировать план."
)
MSG_PRACTICE_PLAN_GENERATION_ERROR_JSON = (
    "Ошибка при обработке ответа от ИИ (неверный JSON). Не удалось создать план."
)
...
# handle_text_message
MSG_LLM_NOT_AVAILABLE = (
    "Вибачте, наразі функція, що потребує мовну модель, недоступна. Спробуйте пізніше."
)
...
MSG_PROCEED_TO_NEXT_QUESTION = (
    "Ваш ответ сохранен. Нажмите кнопку ниже, чтобы перейти к следующему вопросу."
)
...
MSG_COMMAND_NOT_FOUND_START_OVER = (
    "Неизвестная команда или некорректный ввод. Пожалуйста, начните с /start."
)
