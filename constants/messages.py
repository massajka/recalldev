...
# language_command
MSG_NO_LANGUAGES_AVAILABLE = "В данный момент нет доступных языков для изучения. Пожалуйста, попробуйте позже."
MSG_CHOOSE_LANGUAGE = "Выберите язык программирования:"
