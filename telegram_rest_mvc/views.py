...
class View:
    ...
    # legacy support
    command_handler: Callable[[Update, ContextTypes.DEFAULT_TYPE], Awaitable[None]] | None = None
    ...
    async def command(self):  # noqa: D401
        ...
        if self.command_handler:
            ...
            raise NotImplementedError("View must implement command() or set command_handler")

    @classmethod
    def as_handler(cls) -> Callable[[Update, ContextTypes.DEFAULT_TYPE], Coroutine[Any, Any, None]]:
